...
\newcommand\StudProgram{Biomedicínská a klinická technika, strukturovaný, Bakalářský}
...
\newcommand\StudBranch{Biomedicínský technik}   % pro prgoram EaI mag. (dobihajici i strukt.)
...
\newcommand\FirstandFamilyName{Bc. Miroslav Mužný}
\newcommand\Supervisor{Ing. Jan Mužík}
...
\iflanguage{czech}{
	 ...
	 \typeout{***************************************************}
	 \newcommand\Department{Společné pracoviště biomedicínského inženýrství FBMI a 1.LF}
	 \newcommand\Faculty{Fakulta biomedicínského inženýrství}
	 ...
	 \typeout{***************************************************}
	 \newcommand\Department{Joint Department of Biomedical Engineering CTU and Charles University in Prague}
	 \newcommand\Faculty{Faculty of biomedical engineering}
